...
sportStoreApp.constant("PRODUCT_LIST_CONFIG", {
    classListActive: "btn-info",
    pageCount: 3,
});

sportStoreApp.controller("productListCtrl", [
    "$scope",
    "$filter",
    "$location",
    "PRODUCT_LIST_CONFIG",
    "cart",
    ($scope, $filter, $location, PRODUCT_LIST_CONFIG, cart) => {
        ...
        $scope.getCategoryClass = (category) => {
            return selectedCategory === category ?
                PRODUCT_LIST_CONFIG.classListActive :
                "";
        };
